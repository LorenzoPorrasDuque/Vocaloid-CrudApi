INSERT INTO public.vocaloids (id, name, age) VALUES
(DEFAULT, 'Hatsune Miku', 16),
(DEFAULT, 'Kagamine Rin', 14),
(DEFAULT, 'Kagamine Len', 14),
(DEFAULT, 'Megurine Luka', 20),
(DEFAULT, 'Kaito', 20),
(DEFAULT, 'Meiko', 22);
...
(DEFAULT, 'Cantarella', 'Duet by Kaito and Hatsune Miku', 5),
(DEFAULT, 'Dear cocoa girls', 'Classic song by Meiko', 6);
